...
\begin{tikzpicture}[diagram]
  ...
  \node (blocks) [below=of topography.west, group, yshift=-2.0em] {blocks};
  
  % Block 0
  \node (block-0) [below=of blocks.south, dataset, subset-right] {block-0 [$N_x \times N_y \times N_{z0} \times N_v$]};
