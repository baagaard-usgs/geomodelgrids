...
main(int argc,
     ...
     *
     * The string can be in the form of EPSG:XXXX, WKT, or Proj parameters. In this case, we will specify the
     * coordinates in latitude, longitude, elevation in the WGS84 horizontal datum. The elevation is with respect
    ...
    static const double points[16*3] = {
        /* Points in one-block-flat model */
        37.455, -121.941, 0.0,
