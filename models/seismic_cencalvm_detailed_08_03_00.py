...
def default_vs(depth, vp):
    ...
    """
    return 0.7858 - 1.2344*vp + 0.7949*vp**2 - 0.1238*vp**3 + 0.00064*vp**4
...
def get_rules(fault_block, zone):
    ...
    RULES = {
        "Mantle": upper_mantle,
        "Lower Crust": mafic_great_valley_ophiolite,
        "Great_Valley_Ophiolite": mafic_great_valley_ophiolite,
        "San Leandro G": mafic_great_valley_ophiolite,
        "Logan G": mafic_great_valley_ophiolite,
        "Kjf_Berkeley": franciscan_berkeley,
        "Kjf_Chabot": franciscan_berkeley,
        "Kjf_Foothills": franciscan_foothills,
        "Kjf_Merced": franciscan_napa_sonoma,
        "Kjf_Sur": franciscan_berkeley,
        "Kjf_Napa_Somoma": franciscan_napa_sonoma,
        "Kjf_Bay Block": franciscan_napa_sonoma,
        "Kjf_Evergreen": franciscan_berkeley,
        "Kjf_E_Diablo": franciscan_berkeley,
        "Kjf_W_Diablo": franciscan_berkeley,
        "Valley Sequence": great_valley_sequence_sedimentary,
        "Kgr_Gab": salinian_granitic,
        "Kgr_Halfmoon": salinian_granitic,
        "Kgr_SCoast": salinian_granitic,
        "Kgr_NShelf": salinian_granitic,
        "Great Valley Seq": great_valley_sequence_sedimentary,
        "Cenozoic_Great Valley": tertiary_sedimentary_southbay,
        "Cenozoic_Halfmoon": cenozoic_sedimentary_halfmoonbay,
        "Cenozoic_Ever": tertiary_sedimentary_southbay,
        "T_SouthBay": tertiary_sedimentary_southbay,
        "T_La Honda": tertiary_sedimentary_lahondabasin,
        "T_Pilarcitos": tertiary_sedimentary_southbay,
        "T_Bay_Block_Santa_Rosa": tertiary_sedimentary_southbay,
        "T_Berkeley": tertiary_sedimentary_southbay,
        "Cenozoic": tertiary_sedimentary_southbay,
        "QT_Bay_Block_Santa Rosa": quaternary_tertiary_sedimentary,
        "QT_Merced_Pilarcitos": quaternary_tertiary_sedimentary,
        "QT_South_Bay": quaternary_tertiary_sedimentary,
        "<null>": outside_model,
        "water": seawater,
    }
    return RULES[zone]
