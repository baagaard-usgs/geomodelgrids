...
geomodelgrids::apps::TestInfo::testRunOneBlockFlat(void) {
    ...
    std::cout.rdbuf(coutOrig);
    CPPUNIT_ASSERT_EQUAL(size_t(1194), coutHelp.str().length());
} // testRunOneBlockFlat
...
geomodelgrids::apps::TestInfo::testRunThreeBlocksTopo(void) {
    ...
    std::cout.rdbuf(coutOrig);
    CPPUNIT_ASSERT_EQUAL(size_t(2106), coutHelp.str().length());
...
geomodelgrids::apps::TestInfo::testRunTwoModels(void) {
    ...
    std::cout.rdbuf(coutOrig);
    CPPUNIT_ASSERT_EQUAL(size_t(1252), coutHelp.str().length());
} // testRunTwoModels
...
geomodelgrids::apps::TestInfo::testRunBadMetadata(void) {
    ...
    std::cout.rdbuf(coutOrig);
    CPPUNIT_ASSERT_EQUAL(size_t(2120), coutHelp.str().length());
}
...
geomodelgrids::apps::TestInfo::testRunBadTopSurface(void) {
    ...
    std::cout.rdbuf(coutOrig);
    CPPUNIT_ASSERT_EQUAL(size_t(460), coutHelp.str().length());
}
...
geomodelgrids::apps::TestInfo::testRunBadBlock(void) {
    ...
    std::cout.rdbuf(coutOrig);
    CPPUNIT_ASSERT_EQUAL(size_t(1143), coutHelp.str().length());
